...
<head>
    ...
    <title>Data pengajuan peminjaman barang</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Data pengajuan peminjaman barang</h6>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <a href="tambah_pengajuan.php" class="btn btn-primary">Tambah</a>
                                        <a href="report.php?report=excel-pengajuan" class="btn btn-success">Excel</a>
                                        <a href="report.php?report=pdf-pengajuan" class="btn btn-danger">Pdf</a>
                                    ...
                                    <table class="table table-hover" id="datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_pengajuan.php?id=<?= $row['id']; ?>"><i class="fas fa-edit"></i></a>
                                                    <a href="../model/aksi_admin.php?aksi=delete-pengajuan&&id=<?= $row['id']; ?>" onclick="return confirm('Yakin hapus data ini ?')"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php endforeach ?>
