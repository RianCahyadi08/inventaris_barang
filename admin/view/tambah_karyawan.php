                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="../model/aksi_admin.php?aksi=tambah-karyawan" method="POST">
                                        <div class="form-group">
                                            <label for="">Kode karyawan</label>
                                            <input type="text" class="form-control" name="kode-karyawan" placeholder="Kode karyawan . . ." value="<?= $adminController->getMaxKode("tbl_karyawan", "kode_karyawan"); ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Nip</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="no-telp" placeholder="No telp . . .">
                                        </div>
                                        <div class="form-group">
