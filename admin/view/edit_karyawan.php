                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <?php
                                        $dataKaryawan = $adminController->getKaryawanWhere($id);
                                        if (is_array($dataKaryawan)):
                                            foreach ($dataKaryawan['item'] as $key => $row):
                                    ?>
                                    <form action="../model/aksi_admin.php?aksi=update-karyawan" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="">Nip</label>
                                            <input type="number" class="form-control" name="nip" placeholder="Nip . . ." value="<?= $row['nip']; ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="no-telp" placeholder="No telp . . ." value="<?= $row['no_telp']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Divisi</label>
                                            <input type="text" class="form-control" name="divisi" placeholder="Divisi . . ." value="<?= $row['divisi']; ?>">
                                        </div>
                                        <div class="form-group">
