                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <a href="report.php?report=excel-barang" class="btn btn-success">Excel</a>
                                    ...
                                    <table class="table table-hover" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><img src="../../dir/<?= $row['gambar_barang']; ?>" class="img-thumbnail" width="100" height="100"></td>
                                                <td><?= $row['kode_barang']; ?></td>
                                                <td><?= $row['nama_barang']; ?></td>
                                                <td><?= $row['stok_barang']; ?></td>
                                                <td><?= $row['deskripsi_barang']; ?></td>
                                                <td>
                                                    <a href="edit_barang.php?id=<?= $row['id']; ?>"><i class="fas fa-edit"></i></a>
                                                    <a href="../model/aksi_admin.php?aksi=delete-barang&&id=<?= $row['id']; ?>" onclick="return confirm('Yakin hapus data ini ?')"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
                                            <?php endif ?>
