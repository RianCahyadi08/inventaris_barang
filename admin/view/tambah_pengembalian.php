                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tambah pengembalian barang</h6>
                                </div>
                                <div class="card-body">
                                    <form action="../model/aksi_admin.php?aksi=tambah-pengembalian" method="POST">
                                        <div class="form-group">
                                            <label for="">Kode pengembalian</label>
                                            <input type="text" class="form-control" name="kode-pengembalian" placeholder="Kode peminjaman . . ." value="<?= $adminController->getMaxKode("tbl_pengembalian", "kode_pengembalian"); ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Kode pengajuan</label>
                                            <select name="kode-pengajuan" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jumlah-pengembalian" placeholder="Jumlah pengembalian barang . . ." required="required">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Tanggal pengembalian</label>
                                            <input type="date" class="form-control" name="tgl-pengembalian" placeholder="Tanggal pengembalian barang . . ." required="required">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" class="form-control" id="" cols="30" rows="10" placeholder="Note . . ."></textarea>
                                        </div>
                                        <div class="form-group">
