					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="dashboard_barang.php" class="active">Data barang</a></li>
									<li><a href="dashboard_pengajuan.php" class="">Data pengajuan</a></li>
									<li><a href="dashboard_pengembalian.php" class="">Data pengembalian</a></li>
								</ul>
							</div>
						</li>
					</ul>
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
                            ...
                            <table class="table table-hover" id="example">
								...
								<tbody>
                                    <?php
                                        $dataBarang = $allController->getBarang();
                                        $no = 1;
								    ...
								    <tr>
									    <td><?= $no++; ?></td>
										<td><img src="../dir/<?= $row['gambar_barang']; ?>" class="img img-thumbnail" width="100" height="100"></td>
										<td><?= $row['kode_barang']; ?></td>
									    <td><?= $row['nama_barang']; ?></td>
									    <td><?= $row['stok_barang']; ?></td>
									    <td><?= $row['deskripsi_barang']; ?></td>
									    <td><a href="pengajuan.php?id=<?= $row['id']; ?>" class="btn btn-primary btn-sm">Ajukan peminjaman</a></td>
									</tr>
                                    <?php endforeach ?>
                                    <?php endif ?>
								</tbody>
